...
function wrapper(plugin_info) {
	...
	window.plugin.changeZoomLevel.setup  = function() {
		...
		window.getDataZoomForMapZoomDefault1 = function() { return window.map.getZoom() + 1 };
		window.getDataZoomForMapZoomDefault2 = function() { return window.map.getZoom() + 2 };
		window.getDataZoomForMapZoomDefault3 = function() { return window.map.getZoom() + 3 };
